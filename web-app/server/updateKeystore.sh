...
sed -i -e "s|Admin@org1.example.com/msp/keystore/.*_sk|$UPDATED_KEYSTORE_ORG_1|g" connection.yaml

echo 'updating connection.yaml Org2 adminPrivateKey path with' ${UPDATED_KEYSTORE_ORG_2}

sed -i -e "s|Admin@org2.example.com/msp/keystore/.*_sk|$UPDATED_KEYSTORE_ORG_2|g" connection.yaml
